...
function Landing(props){
    ...
    return(
        ...
        <div className='landing-about-container'>
            ...
            <br/>
            <br/>
            Producer of <a href='https://open.spotify.com/show/6By6iGJKh6kaRoG40br5T4?si=_HygX9TpTBuNPylm_qu2-A' target='_blank'>'The DROP'</a> Vivint.
            <br/>
            <br/>
            </p>
            <p id='landing-learn-more' onClick={() => props.history.push('/about')}>Learn more
