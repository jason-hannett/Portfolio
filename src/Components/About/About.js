    ...
    return(
        <div className='about-container'>
            <div className='about-bio'>
                ...
                <p>Born Jason Hannett but more commonly known as Hooligin.</p>
                <p>Raised in Pleasant Grove, UT a natural creative Jason has spent the last 10 years producing, writing and recording music under the stage name 'Hooligin' with his last project 'Cocaine, Sweats & Depression' amassing over 500,000 streams on <a href='https://open.spotify.com/artist/4uXeNERJzIA74hSk8AwsCm?si=TxsN2LfPRKCRWRNKNdFR5A' target='_blank' id='spotify-link'>Spotify</a>  alone!
                </p>
                ...
                <p>A DevMountain graduate with a certificate and honors achievment for completion of their full stack Web Development course. 
                <br/>
                <br/>
            ...
            <p onClick={() => props.history.push('/portfolio')} id='view-my-work'>View my Work></p>
        </div>
    )
}
